<template>
  <div>
    ...
    <button class="calculator__toggle" :title="t('toggle')" @click="toggleMode">
      <div
        class="calculator__toggle_icon"
        :class="{ 'calculator__toggle_icon--flipped': mode === 'real-to-game' }"
      >
        <ClientOnly>
