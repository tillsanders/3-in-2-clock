<template>
  <div>
    ...
    <div class="calculator__toggle" @click="toggleMode">
      <div class="calculator__toggle_icon" :class="{ 'calculator__toggle_icon--flipped': this.mode === 'real-to-game' }">
        <font-awesome-icon icon="exchange-alt" fixed-width></font-awesome-icon>
      </div>
    </div>
